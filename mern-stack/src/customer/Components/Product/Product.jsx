...
export default function Product() {
 ...
 // console.log("param - ", param);
  ...
  //  console.log("pageNumber - " ,products.products?.totalPages);
    //handle pagination change must have event 1st then value
  ...
  const handleFilter = (value, sectionId) => {
    const searchParams = new URLSearchParams(location.search);
//console.log("sectionId - ", searchParams);
...
useEffect(() => {
  ...
  const data = {
     ...
     // pageNumber: pageNumber - 1 ,
      pageNumber: pageNumber ,//backend pageNumber start from 0
      pageSize: 1,
      stock: stock,
    };
